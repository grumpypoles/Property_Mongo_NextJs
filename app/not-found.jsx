...
function NotFoundPage() {
  return (
    ...
    <div className="container max-w-2xl py-24 m-auto">
      <div
        className="px-6 py-24 m-4 mb-4 bg-white border rounded-md shadow-md md:m-0"
      >
        <div className="flex justify-center">
        <FaExclamationTriangle className="text-yellow-400 fas fa-exclamation-triangle fa-5x text-8xl"/>
